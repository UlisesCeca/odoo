...
class res_partner(osv.Model, format_address):
    ...
    _columns = {
		...
		'inscripciones': fields.many2many('res.inscripcion', 'tablainscripcion','name','edicion', 'Inscripciones'),
        'esalumno': fields.boolean('Alumno', help="Si no esta seleccionado no es un alumno."),
